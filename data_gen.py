...
def get_train_val_test_smiles():
    ...
    create_folder('/mnt/raw_data/transvae/train_data/train_batch/')
    create_folder('/mnt/raw_data/transvae/test_data/test_batch/')
    create_folder('/mnt/raw_data/transvae/test_data/val_batch/')
    ...
    pickle_save(smiles_train, '/mnt/raw_data/transvae/train_data/train_batch/smiles.pkl')
    pickle_save(smiles_test, '/mnt/raw_data/transvae/test_data/test_batch/smiles.pkl')
    pickle_save(smiles_val, '/mnt/raw_data/transvae/test_data/val_batch/smiles.pkl')
