...
if __name__ == "__main__":
    freeze_support()
    ckpt_path = 'checkpoints/TransVAE_qm9_prop_scaffold/'
    ...
    val_path = '/mnt/transvae_qm9_prop_scaffold/test_data/val_batch/'
    ...
    try:
        transvae.load_weights("./checkpoints/TransVAE_qm9_prop_scaffold/")
    except:
