...
if __name__ == "__main__":
    freeze_support()
    ckpt_path = 'checkpoints/TransVAE_qm8_prop_scaffold/'
    create_folder(ckpt_path)
    create_folder("g_net_qm8_prop_scaffold")
    ...
    callbacks = [tf.keras.callbacks.ModelCheckpoint(ckpt_path,
                 ...
                 tf.keras.callbacks.TensorBoard('./logs_transvae_qm8_prop', update_freq=10)]
    ...
    try:
        transvae.load_weights("./checkpoints/TransVAE_qm8_prop_scaffold/")
    except:
    ...
    train_dataset = tf.data.Dataset.from_generator(
        ...
        output_shapes=((MAX_NUM_ATOMS, MAX_NUM_ATOMS, FEATURE_DEPTH + 4), 12))
    ...
    g_net.save('g_net_qm8_prop_scaffold/' + 'GNet')
